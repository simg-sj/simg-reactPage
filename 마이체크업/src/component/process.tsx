    ...
    return(
        <div className='w-full flex justify-center items-center flex-col bg-white py-8'>
            ...
            <div className='flex flex-col relative '>
                ...
                <div className={cn('font-bold px-16 mt-16', {'mt-4': !isPc})}>
                <p>구비서류</p>
                    <h2>
                        1. 보험금 지급청구서<br/>
                    ...
                    <div className='mt-4'>
                        ...
                        <h2>
                            보험금청구접수 대행 : <a href={'https://mycheckup-insu.simg.kr'}
                                            target={'_blank'} rel="noreferrer">https://mycheckup-insu.simg.kr</a>
                        </h2>
                    </div>
                </div>
            </div>
