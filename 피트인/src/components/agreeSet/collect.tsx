    ...
    return(
        <div className='flex flex-col mt-4 base_font text-[12px] px-4 space-y-4 bg-white'>
            ...
            <div className='flex flex-col'>
                ...
                <p>º 보험계약 상담, 재무설계서비스, 보험계약 인수여부 판단(건강진단 및 계약 적부조사 포함)• 실손형보험 중복확인 및 정액담보 가입사항 확인을 위한 보험사 가입조회, 보험가입 의무대상 확인, 민원 및 분쟁 관련대응, 보험료출수납업무</p>
            </div>
            <div className='flex flex-col'>
                ...
                <p>
                    ...
                    º 개인(신용)정보<br/>
                    - 일반개인정보 : 성명, CI, 주소, 생년월일, 이메일, 유ㆍ무선 전화번호, 국적, 직업, 운전여부, 주행거리정보, 국내거소신고번호, 외국인체류자격·코드 , 상호명, 업종명,
                    보험가입 의무대상 일련번호<br/>
                    - 신용거래정보 : 본인계좌(카드)정보, 보험계약정보 (상품종류, 보험가입금액 등)ㆍ보험금정보 (보험금 지급사유, 지급금액, 사고정보 등), 계약 전 알릴 의무사항 - 신용능력정보
                    : 소득 및 신용도 판단 정보</p>
            </div>
            <div className='flex flex-col'>
